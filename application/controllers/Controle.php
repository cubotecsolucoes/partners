...
// EVENTOS
	...
	public function lugaresOcupados()
	{
		$this->load->model('lugares_model','lugares');

		print_r($this->lugares->getLugeresOcupados());

		echo("<br>");

		print_r($this->lugares->getLugaresLivres('direita','mezanino'));
	}
