<header id="home">
    <div id="home-slider" class="carousel slide carousel-fade" data-ride="carousel">
      <div class="carousel-inner">
        ...
        <div class="item" style="background-image: url(<?php echo(base_url()); ?>assets/images/slider/8.jpg)">
          <div class="caption">
            <h1 class="animated fadeInLeftBig">Partners <span>Centro De Dança</span></h1>
            <p class="animated fadeInRightBig">Aqui Tem Dança, Aqui Tem Arte</p>
            <a data-scroll class="btn btn-start animated fadeInUpBig" href="#services">Saiba Mais</a>
    ...
    <div class="footer-top wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
      <div class="container text-center">
        <div class="footer-logo">
          <a href="index.html"><img class="img-responsive" src="<?php echo(base_url()); ?>assets/images/logo.svg" alt=""></a>
        </div>
        <div class="social-icons">
          <ul>
